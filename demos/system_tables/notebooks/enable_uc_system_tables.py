...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=governance&org_id=7881628391874129&notebook=%2F_enable_system_tables&demo_name=uc-04-system-tables&event=VIEW&path=%2F_dbdemos%2Fgovernance%2Fuc-04-system-tables%2F_enable_system_tables&version=1">
...
# schemas_to_enable = ['operational_data']
schemas_to_enable
