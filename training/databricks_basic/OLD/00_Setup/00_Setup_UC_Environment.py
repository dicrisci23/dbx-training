...
spark.sql(f"CREATE CATALOG IF NOT EXISTS {user_catalog_name} MANAGED LOCATION 'abfss://unitycatalog@btelligentdbwsdemouc.dfs.core.windows.net/'")
...
spark.sql(f"CREATE SCHEMA IF NOT EXISTS {user_catalog_name}.source")
...
spark.sql(f"CREATE VOLUME IF NOT EXISTS {user_catalog_name}.adventureworks.adventureworks_files")
